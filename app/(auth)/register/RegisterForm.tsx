...
//             <div key={field}>
//               <label className="block text-sm text-slate-300 mb-1 capitalize">{field}</label>
//               <input
...
//           <button
//             type="submit"
//             className="w-full py-2.5 text-white bg-indigo-600 hover:bg-indigo-500 rounded-xl transition font-semibold"
//           >
//             Create Account
//           </button>
//         </form>
...
//           <Link href={`/login?secret=${encodeURIComponent(secret)}`} className="text-indigo-400 hover:underline">
//             Sign in
//           </Link>
//         </p>
//       </div>
