...
export default async function GitHubActivity() {
  ...
  return (
    <div className="md:rounded-2xl border border-gray-200 bg-white p-3.5 sm:p-5 text-slate-800 dark:border-slate-700/50 dark:bg-gray-900/60 dark:text-slate-200">
      {/* Header */}
