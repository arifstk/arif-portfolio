...
const Nav = () => {
  ...
  return (
    <div>
      <div className='transition-all duration-200 py-1.5 z-100 fixed w-full bg-violet-100/90 dark:bg-gray-950/90 border-b border-gray-200 dark:border-gray-600'>
        <div className='flex items-center justify-between max-w-7xl mx-auto h-full px-4'>
          {/* Logo */}
          <Logo />
          <div className='flex items-center gap-0 md:gap-4'>
            ...
            {/* contact */}
            <Link href={'/contact'}
              className='text-sm bg-violet-800 hover:bg-violet-600 dark:bg-violet-700 dark:hover:bg-violet-600 font-medium px-3 py-1.5 rounded-xl text-white shadow-md shadow-violet-700/20 transition-colors duration-200 dark:backdrop-blur-sm'
            >
              Contact
            </Link>
            <ThemeToggler />
