...
//   return (
//     <div>
//       <div className='transition-all duration-200 h-[12vh] z-100 fixed w-full backdrop-blur-sm'>
...
//               className={`relative group text-sm text-blue-600 font-medium transition-colors duration-200 py-1 ${active ? "text-blue-800 dark:text-blue-400" : ""
//               }`}
//               >
//                 {link.name}
//               </Link>
