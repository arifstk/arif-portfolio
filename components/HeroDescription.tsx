...
const HeroDescription = ({ isMobile = false }: { isMobile?: boolean }) => {
  ...
  return (
    <p className="w-auto md:font-stretch-normal md:text-lg md:tracking-wide leading-7 mb-6 min-h-30 text-white/80 md:text-gray-600 dark:text-white/80 md:dark:text-white/60">
      {description}
    </p>
  );
};
