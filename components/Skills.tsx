              ...
              {category.skills.map((skill, skillIndex) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-1.5 sm:p-3 bg-white dark:bg-gray-700 dark:border-gray-400 rounded-lg text-violet-700 dark:text-violet-500 transition-all duration-300 group-hover:text-[#2b7473] group-hover:scale-110 shadow-[0_2px_8px_rgba(0,0,0,0.02)] group-hover:shadow-[0_4px_12px_rgba(0,123,255,0.1)] mb-3">
