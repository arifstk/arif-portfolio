...
//       {/* ── Main ── */}
//       <div className="flex-1 flex flex-col min-h-screen w-[92%] xl:w-[80%] mx-auto overflow-x-hidden pl-0 sm:pl-5 sm:mt-0">
      ...
      <div className="flex-1 flex flex-col min-h-screen w-[92%] xl:w-[80%] mx-auto overflow-x-hidden pl-0 sm:pl-5 sm:mt-0">
        <header className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 py-4 flex items-center justify-between sticky top-0 z-10">
          ...
          {tab !== "messages" && tab !== "hire" && tab !== "newsletter" && (
            <button
              onClick={handleAdd}
              className="flex items-center gap-2 px-4 py-2 bg-violet-700 hover:bg-violet-600 text-white text-sm font-medium rounded-xl transition-colors shadow-sm shadow-violet-200 dark:shadow-none cursor-pointer"
            >
              <PlusIcon />
              {tab === "projects" ? "project" : tab === "contact" ? "entry" : "link"}
            </button>
